...
namespace KINEMATION.FPSAnimationFramework.Runtime.Playables
{
    ...
    public class FPSPlayablesController : MonoBehaviour, IPlayablesController
    {
        ...
        public virtual bool PlayPose(FPSAnimationAsset asset)
        {
            ...
            FPSAnimatorPlayable animPlayable = new FPSAnimatorPlayable(_playableGraph, asset.animClip, null)
            {
        ...
        public virtual bool PlayAnimation(FPSAnimationAsset asset, float startTime = 0f)
        {
            ...
            FPSAnimatorPlayable animPlayable = new FPSAnimatorPlayable(_playableGraph, asset.animClip, 
            ...
            FPSAnimatorPlayable overridePlayable = new FPSAnimatorPlayable(_playableGraph, asset.animClip, null)
            {
                blendTime = blendTime,
                autoBlendOut = true
            };
