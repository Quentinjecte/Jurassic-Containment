...
namespace SetaVolumeSwitcher
{
    public class VolumeSwitcher : EditorWindow
    {
        ...
        private void CheckExistingPrefab()
        {
            ...
            foreach (GameObject obj in GameObject.FindObjectsByType<GameObject>(FindObjectsInactive.Exclude))
            {
        ...
        private void OnGUI()
        {
            ...
            foreach (var prefab in prefabs)
            {
                ...
                if (currentTab == VolumeTab.Realistic && isStylized) continue;
                if (currentTab == VolumeTab.Stylized && !isStylized) continue;
        ...
        private void SpawnPrefab(GameObject prefab)
        {
            ...
            {
                Undo.DestroyObjectImmediate(currentInstance);
            }
